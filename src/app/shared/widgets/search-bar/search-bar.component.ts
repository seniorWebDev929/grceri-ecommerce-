import { Component, OnInit, Output, EventEmitter, OnDestroy, ChangeDetectorRef,
	HostListener, HostBinding, NgZone, OnChanges, SimpleChanges, ElementRef,
	ViewChild, AfterViewInit, PLATFORM_ID, Inject, Input } from '@angular/core';
...
// SERVICES
import { CategoryAPIService, AuthService, LocalStorage, SessionStorage,
				 VoiceService, SearchBarService, ProductAPIService,
				 GoogleAnalyticsService, BarcodeService } from '../../../shared/services';
